namespace SimpleContactSystem
{
    partial class frmMDIParent
    {
        ...
        private void InitializeComponent()
        {
            ...
            maintencesToolStripMenuItem = new ToolStripMenuItem();
            instructorsToolStripMenuItem = new ToolStripMenuItem();
            coursesToolStripMenuItem = new ToolStripMenuItem();
            browseCoursesToolStripMenuItem = new ToolStripMenuItem();
            ...
            menuStrip.Items.AddRange(new ToolStripItem[] { fileMenu, maintencesToolStripMenuItem, viewMenu, windowsMenu, helpMenu });
